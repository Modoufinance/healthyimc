...
const Privacy = () => {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Politique de Confidentialité - HealthyIMC",
    "description": "Politique de confidentialité et protection des données personnelles de HealthyIMC",
    "url": "https://healthyimc.com/confidentialite"
  };
  ...
  return (
    <>
      <SEO
        ...
        description="Découvrez comment nous protégeons vos données personnelles et respectons votre vie privée sur HealthyIMC."
        keywords="confidentialité, protection données, rgpd, cookies, politique confidentialité"
        canonicalUrl="https://healthyimc.com/confidentialite"
